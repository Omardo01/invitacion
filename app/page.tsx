...
const options = [
  ...
  },
  {
    href: "/opcion-25",
    number: "25",
    name: "Tarjeta Floral Enmarcada",
    tagline: "Tarjeta con marco plata · foto en arco · ramo lila · tilt 3D · brillo animado",
    bg: "bg-[#f4f3f7]",
    fg: "text-[#332b3f]",
    accent: "border-[#a9a7b8]",
    chip: "bg-[#7c7a90] text-white",
    previewFont: "var(--font-great-vibes)",
    preview: "G & Z",
    customizable: false,
  },
  {
    href: "/opcion-26",
    number: "26",
    name: "Acuarela Botánica Lila",
    tagline: "Lavanda lila en acuarela · foto en óvalo flotante · pétalos · animada",
    bg: "bg-[#f7f5fb]",
    fg: "text-[#322a40]",
    accent: "border-[#b89ad6]",
    chip: "bg-[#7d5fa8] text-white",
    previewFont: "var(--font-great-vibes)",
    preview: "G & Z",
    customizable: false,
  },
  {
    href: "/opcion-27",
    number: "27",
    name: "Lavanda Editorial",
    tagline: "Lavanda acuarela · foto en arco + B/N · música · itinerario timeline",
    bg: "bg-[#f5f3ef]",
    fg: "text-[#4a4458]",
    accent: "border-[#b9a5d4]",
    chip: "bg-[#8b75ac] text-white",
    previewFont: "var(--font-great-vibes)",
    preview: "G & Z",
    customizable: false,
  },
  {
    ...
    number: "28",
    name: "Lavanda Sobre",
    tagline: "Sobre lavanda · countdown · calendario · lluvia de sobres · sin niños",
    bg: "bg-[#c1b0db]",
    fg: "text-white",
    accent: "border-[#8b75ac]",
    chip: "bg-white text-[#8b75ac]",
    previewFont: "var(--font-great-vibes)",
    preview: "G | Z",
    customizable: false,
  },
